...
void Creatures::Encounter::Prisoner::dialogue()
{
	bool answerAgain{ false };
...
void Creatures::Encounter::Prisoner::dialogueKillOrNot()
{
	bool answerAgain{ false };
	...
	do
	{
		...
		case '1':// option 1: (Kill her)
			...
			std::cout << "(You take your weapon attack her.\n"
				<< "(Like she said, she didn't do anything)\n"
		...
		case '3':// option 3: Become my slave and join my party!
			...
			std::cout << "(While shse was crying you heard a yes, but Necoto said she didn't "
				<< "like that)\n(So she was saved by getting erased from the game)\n";
			takeDamage(hp);
			answerAgain = false;
